        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p><strong>No:</strong> {{ $pembelians->id }}</p>
                        <p><strong>Nama Barang:</strong> {{ $pembelians->nama_produk }}</p>
                        <p><strong>Tanggal Pembelian:</strong> {{ $pembelians->tanggal_pembelian }}</p>
                        <p><strong>Harga:</strong> {{ $pembelians->biaya }}</p>
                        <p><strong>Jumlah Barang:</strong> {{ $pembelians->jumlah_pembelian }}</p>
